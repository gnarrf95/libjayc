...
# Start syslog service and execute jsys_test daemon with any IP, port 1234, syslog logging and SHA256 hash
CMD service rsyslog start && jsys_test --ip 0.0.0.0 --port 1234 --syslog daemon --hash 2